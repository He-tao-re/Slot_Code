...
def rtp_data():
    ...
    # # RTP_Static_G10007.static_data()
    print(10008)
    RTP_Static_G10008.static_data()
    print(10009)
    RTP_Static_G10009.static_data()
    print(10010)
    RTP_Static_G10010.static_data()
    print(10011)
    RTP_Static_G10011.static_data()
    print(10012)
    ...
    print(10021)
    RTP_Static_G10021.static_data()
    print(10022)
    RTP_Static_G10022.static_data()
    print(10025)
    RTP_Static_G10025.static_data()
    # print(10029)
    # RTP_Static_G10029.static_data()
