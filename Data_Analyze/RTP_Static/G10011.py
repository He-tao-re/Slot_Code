...
def static_data():
    ...
    for user_data in users_data:
        ...
        for record in spin_data:
            ...
            if gameType == 0 and "rewardId" not in testModel.keys():
            ...
            if "rewardId" in testModel.keys():
                ...
                if gameType == 0:
                    ...
                    betGold = data_dic["data"]["betGold"]
                    winGold = data_dic["data"]["totalWinGold"]

                    mul = winGold / betGold

                    free_spin_left = data_dic["data"]["leftFreeNum"]

                    if free_spin_left == 0:
                        analyze_data[Variable.REWARD]["accumulative_win"] += winGold
                        analyze_data[Variable.REWARD]["accumulative_mul"] += mul
