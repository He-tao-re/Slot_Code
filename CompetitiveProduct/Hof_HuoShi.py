...
def run(i):
    ...
    for j in range(2500):
        try:
            ...
            params = f"id={a}&cmd=spin&params=%7B%0A%20%20%20%22bet%22%20%3A%20100000%2E0%2C%0A%20%20%20%22fastSpin%22%20%3A%20true%2C%0A%20%20%20%22features%22%20%3A%20null%2C%0A%20%20%20%22gameId%22%20%3A%20243%2C%0A%20%20%20%22lines%22%20%3A%2050%2C%0A%20%20%20%22restrictedKey%22%20%3A%20%22433e086ac3b849b080224da0e1662ae9%22%2C%0A%20%20%20%22session%22%20%3A%20%22uvFBr1vaW154%2D1772983200815338832%22%0A%7D%0A"
                    ...
                    if content_json['result']['gameInfo']['bonus']['type'] == "freeSpins":
                        ...
                        while active:
                            try:
                                ...
                                params = f"id={a}&cmd=bonusGame&params=%7B%0A%20%20%20%22bonusToken%22%20%3A%20%22gs%3Ag%2E243%3Ab%3Ak%2E"+bonusToken+"%22%2C%0A%20%20%20%22gameId%22%20%3A%20243%2C%0A%20%20%20%22restrictedKey%22%20%3A%20%22433e086ac3b849b080224da0e1662ae9%22%2C%0A%20%20%20%22session%22%20%3A%20%22uvFBr1vaW154%2D1772983200815338832%22%0A%7D%0A"
                                url = "https://fb-lb.houseoffuns.com/onlinecasino/games/handler.ashx"
                                session = requests.session()
