...
import datetime
import Games.Game_1001_Britain.Britain_Slot as Game_Slot
...
class TestCase(object):
    ...
    def test(self, test_time, total_bet, recoder, sym_count, print_json):
        ...
        #
        # respin_rtp = self.bingo_win / self.all_bet
        # respin_interval = test_time / self.respin_hit
        # respin_mul = self.bingo_win / self.respin_hit / total_bet
        print('===========')
...
if __name__ == '__main__':
    TestCase().test(500000, 1000, recoder=False, sym_count=False, print_json=False)
